	...
	<div class="box">
		<div class="box-body">
			<div class="space-childs">
                ...
                <script type="text/javascript" src="{{asset('js/editProject.js')}}"></script>
				<script type="text/javascript">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input name="name" value="{{$project->name}}" type="text" class="form-control" placeholder="Nombre del Proyecto" autocomplete="off" />
						</div>
						
						<div class="form-group">
							<label class="small">Descripción de la Obra</label>
							<textarea name="description" placeholder="Descripción de la Obra" class="form-control">{{$project->description}}</textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input name="start"  value="{{$project->start}}" type="date" placeholder="Fecha de Incio" class="form-control" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input name="salary" value="{{$modifiers['salary']}}" type="number" class="form-control project-modifier" placeholder="Salario Mínimo" autocomplete="off" />
						</div>
						<div class="form-group">
							<label class="small">Bono de Alimentación</label>
							<input name="salaryBonus" value="{{$modifiers['salaryBonus']}}" type="number" class="form-control project-modifier" project-modifier placeholder="Bono de Alimentación" autocomplete="off" />
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input name="expenses" value="{{$modifiers['expenses']}}" id="expenses" type="number" class="form-control project-modifier" placeholder="Administración y gastos generales" autocomplete="off" />
						...
						<div class="form-group">
							...
							<div class="input-group">
								<input name="utility" value="{{$modifiers['utility']}}" id="utility" type="number" class="form-control project-modifier" placeholder="Utilidad + Comisión de ventas" autocomplete="off" />
								<div class="input-group-addon">%</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group">
								<input name="unexpected" value="{{$modifiers['unexpected']}}" id="unexpected" type="number" class="form-control project-modifier" placeholder="Imprevisto de compra" autocomplete="off" />
								<div class="input-group-addon">%</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="input-group">
								<input name="fcas" value="{{$modifiers['fcas']}}" id="fcas" type="number" class="form-control project-modifier" placeholder="Factor de Costos Asociados al Salario" autocomplete="off" />
								<div class="input-group-addon">%</div>
							</div>
						</div>
						<div class="form-group">
...
<tr><td colspan="6" class="delete-if-not-empty">
				...
				<button id="createProject" type="submit" class="btn btn-outline-warning float-right">
					Actualizar
				</button>
			</form>
